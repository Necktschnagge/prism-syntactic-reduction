...
module control_flow
	...
	//Element cfblk1_Output_2, df inputs ['y_cfblk2_15150658'], cf transitions ['cfblk3_Output_3']
	...
	//Element cfblk4_Output_4, df inputs ['y_cfblk5_132556837', 'x_cfblk4_1_310919350'], cf transitions ['check_redandancy3']
	[cfblk4_Output_4] cf=cfblk4_Output_4 -> 1.0:(cf'=check_redandancy3);
	//Element cfblk5_Output_5, df inputs ['y_cfblk4_93421444', 'x_cfblk5_1_1602387319'], cf transitions ['cfblk4_Update_6']
	[cfblk5_Output_5] cf=cfblk5_Output_5 -> 1.0:(cf'=cfblk4_Update_6);
	//Element cfblk4_Update_6, df inputs ['y_cfblk5_132556837', 'x_cfblk4_1_310919350'], cf transitions ['check_redandancy4']
	[cfblk4_Update_6] cf=cfblk4_Update_6 -> 1.0:(cf'=check_redandancy4);
	//Element cfblk5_Update_7, df inputs ['y_cfblk4_93421444', 'x_cfblk5_1_1602387319'], cf transitions ['cfblk2_Output_1']
	...
	//Element compare0, df inputs ['redundancy_model22_cfblk2_0', 'y_cfblk2_15150658_2', 'y_cfblk2_15150658'], cf transitions ['cfblk2_Output_1_3', 'cfblk1_Output_2', 'stop_system']
	...
	//Element compare2, df inputs ['redundancy_model22_cfblk3_2', 'y_cfblk3_54286051_2', 'y_cfblk3_54286051'], cf transitions ['cfblk3_Output_3_3', 'cfblk4_Output_4', 'stop_system']
	...
	//Element cfblk4_Output_4_2, df inputs ['y_cfblk5_132556837', 'x_cfblk4_1_310919350'], cf transitions ['compare3']
	[cfblk4_Output_4_2] cf=cfblk4_Output_4_2 -> 1.0:(cf'=compare3);
	//Element cfblk4_Output_4_3, df inputs ['y_cfblk5_132556837', 'x_cfblk4_1_310919350'], cf transitions ['cfblk5_Output_5']
	[cfblk4_Output_4_3] cf=cfblk4_Output_4_3 -> 1.0:(cf'=cfblk5_Output_5);
	//Element compare3, df inputs ['redundancy_model22_cfblk4_3', 'y_cfblk4_93421444_2', 'y_cfblk4_93421444'], cf transitions ['cfblk4_Output_4_3', 'cfblk5_Output_5', 'stop_system']
	...
	//Element cfblk4_Update_6_2, df inputs ['y_cfblk5_132556837', 'x_cfblk4_1_310919350'], cf transitions ['compare4']
	[cfblk4_Update_6_2] cf=cfblk4_Update_6_2 -> 1.0:(cf'=compare4);
	//Element cfblk4_Update_6_3, df inputs ['y_cfblk5_132556837', 'x_cfblk4_1_310919350'], cf transitions ['cfblk5_Update_7']
	[cfblk4_Update_6_3] cf=cfblk4_Update_6_3 -> 1.0:(cf'=cfblk5_Update_7);
	//Element compare4, df inputs ['redundancy_model22_cfblk4_3', 'x_cfblk4_1_310919350_2', 'x_cfblk4_1_310919350'], cf transitions ['cfblk4_Update_6_3', 'cfblk5_Update_7', 'stop_system']
...
module error_propagation
	...
	//Element cfblk2_Output_1, df outputs ['y_cfblk2_15150658']
	[cfblk2_Output_1] (true) -> 1:(y_cfblk2_15150658'=ok);	// <-- 
	//Element cfblk3_Output_3, df outputs ['y_cfblk3_54286051']
	[cfblk3_Output_3] (true) -> 1:(y_cfblk3_54286051'=ok);	// <-- 
	//Element cfblk4_Output_4, df inputs ['y_cfblk5_132556837', 'x_cfblk4_1_310919350'], df outputs ['y_cfblk4_93421444']
	[cfblk4_Output_4] (y_cfblk5_132556837=ok) & (x_cfblk4_1_310919350=ok) -> 0.98:(y_cfblk4_93421444'=ok) + 0.02:(y_cfblk4_93421444'=error);	// <-- 
	[cfblk4_Output_4] (y_cfblk5_132556837!=ok) | (x_cfblk4_1_310919350!=ok) -> (y_cfblk4_93421444'=error);	// <-- 
	//Element cfblk5_Output_5, df inputs ['y_cfblk4_93421444', 'x_cfblk5_1_1602387319'], df outputs ['y_cfblk5_132556837']
	[cfblk5_Output_5] (y_cfblk4_93421444=ok) & (x_cfblk5_1_1602387319=ok) -> 0.98:(y_cfblk5_132556837'=ok) + 0.02:(y_cfblk5_132556837'=error);	// <-- 
	[cfblk5_Output_5] (y_cfblk4_93421444!=ok) | (x_cfblk5_1_1602387319!=ok) -> (y_cfblk5_132556837'=error);	// <-- 
	//Element cfblk4_Update_6, df inputs ['y_cfblk5_132556837', 'x_cfblk4_1_310919350'], df outputs ['x_cfblk4_1_310919350']
	...
	//Element cfblk5_Update_7, df inputs ['y_cfblk4_93421444', 'x_cfblk5_1_1602387319'], df outputs ['x_cfblk5_1_1602387319']
	[cfblk5_Update_7] (y_cfblk4_93421444=ok) & (x_cfblk5_1_1602387319=ok) -> 0.98:(x_cfblk5_1_1602387319'=ok) + 0.02:(x_cfblk5_1_1602387319'=error);	// <-- 
	[cfblk5_Update_7] (y_cfblk4_93421444!=ok) | (x_cfblk5_1_1602387319!=ok) -> (x_cfblk5_1_1602387319'=error);	// <-- 
	//Element cfblk2_Output_1_2, df outputs ['y_cfblk2_15150658_2']
	[cfblk2_Output_1_2] (true) -> 1:(y_cfblk2_15150658_2'=ok);	// <-- 
	//Element cfblk2_Output_1_3, df outputs ['y_cfblk2_15150658']
	[cfblk2_Output_1_3] (true) -> 1:(y_cfblk2_15150658'=ok);	// <-- 
	//Element cfblk3_Output_3_2, df outputs ['y_cfblk3_54286051_2']
	[cfblk3_Output_3_2] (true) -> 1:(y_cfblk3_54286051_2'=ok);	// <-- 
	//Element cfblk3_Output_3_3, df outputs ['y_cfblk3_54286051']
	[cfblk3_Output_3_3] (true) -> 1:(y_cfblk3_54286051'=ok);	// <-- 
	//Element cfblk4_Output_4_2, df inputs ['y_cfblk5_132556837', 'x_cfblk4_1_310919350'], df outputs ['y_cfblk4_93421444_2']
	[cfblk4_Output_4_2] (y_cfblk5_132556837=ok) & (x_cfblk4_1_310919350=ok) -> 0.98:(y_cfblk4_93421444_2'=ok) + 0.02:(y_cfblk4_93421444_2'=error);	// <-- 
	[cfblk4_Output_4_2] (y_cfblk5_132556837!=ok) | (x_cfblk4_1_310919350!=ok) -> (y_cfblk4_93421444_2'=error);	// <-- 
	//Element cfblk4_Output_4_3, df inputs ['y_cfblk5_132556837', 'x_cfblk4_1_310919350'], df outputs ['y_cfblk4_93421444']
	[cfblk4_Output_4_3] (y_cfblk5_132556837=ok) & (x_cfblk4_1_310919350=ok) -> 0.98:(y_cfblk4_93421444'=ok) + 0.02:(y_cfblk4_93421444'=error);	// <-- 
	[cfblk4_Output_4_3] (y_cfblk5_132556837!=ok) | (x_cfblk4_1_310919350!=ok) -> (y_cfblk4_93421444'=error);	// <-- 
	//Element cfblk4_Update_6_2, df inputs ['y_cfblk5_132556837', 'x_cfblk4_1_310919350'], df outputs ['x_cfblk4_1_310919350_2']
	[cfblk4_Update_6_2] (y_cfblk5_132556837=ok) & (x_cfblk4_1_310919350=ok) -> 0.98:(x_cfblk4_1_310919350_2'=ok) + 0.02:(x_cfblk4_1_310919350_2'=error);	// <-- 
	[cfblk4_Update_6_2] (y_cfblk5_132556837!=ok) | (x_cfblk4_1_310919350!=ok) -> (x_cfblk4_1_310919350_2'=error);	// <-- 
	//Element cfblk4_Update_6_3, df inputs ['y_cfblk5_132556837', 'x_cfblk4_1_310919350'], df outputs ['x_cfblk4_1_310919350']
