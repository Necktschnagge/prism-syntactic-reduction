...
module control_flow
	...
	//Element cfblk5_Output_3, df inputs ['y_cfblk2_3054816427', 'y_cfblk3_3093951820'], cf transitions ['cfblk1_Output_4']
	...
	//Element compare0, df inputs ['redundancy_model95_cfblk3_0', 'y_cfblk3_3093951820_2', 'y_cfblk3_3093951820'], cf transitions ['cfblk3_Output_1_3', 'cfblk2_Output_2', 'stop_system']
	...
	//Element compare1, df inputs ['redundancy_model95_cfblk2_1', 'y_cfblk2_3054816427_2', 'y_cfblk2_3054816427'], cf transitions ['cfblk2_Output_2_3', 'cfblk5_Output_3', 'stop_system']
	...
	//Element compare3, df inputs ['redundancy_model95_cfblk4_3', 'y_cfblk4_3133087213_2', 'y_cfblk4_3133087213'], cf transitions ['cfblk4_Output_5_3', 'cfblk3_Output_1', 'stop_system']
...
module error_propagation
	...
	//Element cfblk3_Output_1, df outputs ['y_cfblk3_3093951820']
	[cfblk3_Output_1] (true) -> 1:(y_cfblk3_3093951820'=ok);	// <-- 
	//Element cfblk2_Output_2, df outputs ['y_cfblk2_3054816427']
	[cfblk2_Output_2] (true) -> 1:(y_cfblk2_3054816427'=ok);	// <-- 
	//Element cfblk5_Output_3, df inputs ['y_cfblk2_3054816427', 'y_cfblk3_3093951820'], df outputs ['y_cfblk5_3172222606']
	[cfblk5_Output_3] (y_cfblk2_3054816427=ok) & (y_cfblk3_3093951820=ok) -> 0.974002239936:(y_cfblk5_3172222606'=ok) + 0.025997760064:(y_cfblk5_3172222606'=error);	// <-- 
	[cfblk5_Output_3] (y_cfblk2_3054816427!=ok) | (y_cfblk3_3093951820!=ok) -> (y_cfblk5_3172222606'=error);	// <-- 
	//Element cfblk4_Output_5, df outputs ['y_cfblk4_3133087213']
	[cfblk4_Output_5] (true) -> 1:(y_cfblk4_3133087213'=ok);	// <-- 
	//Element cfblk3_Output_1_2, df outputs ['y_cfblk3_3093951820_2']
	[cfblk3_Output_1_2] (true) -> 1:(y_cfblk3_3093951820_2'=ok);	// <-- 
	//Element cfblk3_Output_1_3, df outputs ['y_cfblk3_3093951820']
	[cfblk3_Output_1_3] (true) -> 1:(y_cfblk3_3093951820'=ok);	// <-- 
	//Element cfblk2_Output_2_2, df outputs ['y_cfblk2_3054816427_2']
	[cfblk2_Output_2_2] (true) -> 1:(y_cfblk2_3054816427_2'=ok);	// <-- 
	//Element cfblk2_Output_2_3, df outputs ['y_cfblk2_3054816427']
	[cfblk2_Output_2_3] (true) -> 1:(y_cfblk2_3054816427'=ok);	// <-- 
	//Element cfblk4_Output_5_2, df outputs ['y_cfblk4_3133087213_2']
	[cfblk4_Output_5_2] (true) -> 1:(y_cfblk4_3133087213_2'=ok);	// <-- 
	//Element cfblk4_Output_5_3, df outputs ['y_cfblk4_3133087213']
	[cfblk4_Output_5_3] (true) -> 1:(y_cfblk4_3133087213'=ok);	// <-- 
endmodule
